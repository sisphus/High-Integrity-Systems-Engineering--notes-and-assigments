...
package ada_main is
   ...
   u00001 : constant Version_32 := 16#bd0ff6da#;
   ...
   u00140 : constant Version_32 := 16#5e511f79#;
   pragma Export (C, u00140, "ada__text_io__generic_auxB");
   u00141 : constant Version_32 := 16#d2ac8a2d#;
   pragma Export (C, u00141, "ada__text_io__generic_auxS");
   u00142 : constant Version_32 := 16#d71ab463#;
   pragma Export (C, u00142, "system__fat_fltS");
   u00143 : constant Version_32 := 16#1b1598b6#;
   pragma Export (C, u00143, "system__img_fltS");
   ...
   u00146 : constant Version_32 := 16#1efd3382#;
   pragma Export (C, u00146, "system__img_utilB");
   u00147 : constant Version_32 := 16#6331cfb6#;
   pragma Export (C, u00147, "system__img_utilS");
   u00148 : constant Version_32 := 16#b132d2b7#;
   ...
   u00151 : constant Version_32 := 16#8438771b#;
   pragma Export (C, u00151, "system__img_lluS");
   u00152 : constant Version_32 := 16#b82039c7#;
   pragma Export (C, u00152, "system__powten_lfltS");
   u00153 : constant Version_32 := 16#8dbcc555#;
   pragma Export (C, u00153, "system__img_llfS");
   u00154 : constant Version_32 := 16#8bf81384#;
   pragma Export (C, u00154, "system__fat_llfS");
   u00155 : constant Version_32 := 16#8fb1834c#;
   pragma Export (C, u00155, "system__powten_llfS");
   u00156 : constant Version_32 := 16#c3bdb2c8#;
   pragma Export (C, u00156, "system__val_fltS");
   u00157 : constant Version_32 := 16#b13844f6#;
   pragma Export (C, u00157, "system__exn_fltS");
   u00158 : constant Version_32 := 16#2611fc39#;
   pragma Export (C, u00158, "system__val_lfltS");
   u00159 : constant Version_32 := 16#0f79a52f#;
   pragma Export (C, u00159, "system__exn_lfltS");
   u00160 : constant Version_32 := 16#86c64e74#;
   pragma Export (C, u00160, "system__val_llfS");
   u00161 : constant Version_32 := 16#22d7655f#;
   pragma Export (C, u00161, "system__exn_llfS");
   u00162 : constant Version_32 := 16#f64b89a4#;
   pragma Export (C, u00162, "ada__integer_text_ioB");
   u00163 : constant Version_32 := 16#b4dc53db#;
   pragma Export (C, u00163, "ada__integer_text_ioS");
   u00164 : constant Version_32 := 16#dddfe8f1#;
   pragma Export (C, u00164, "system__img_biuS");
   u00165 : constant Version_32 := 16#90812f2f#;
   pragma Export (C, u00165, "system__img_llbS");
   u00166 : constant Version_32 := 16#5eeebe35#;
   pragma Export (C, u00166, "system__img_lliS");
   u00167 : constant Version_32 := 16#e770da5d#;
   pragma Export (C, u00167, "system__img_lllbS");
   u00168 : constant Version_32 := 16#ad86ddd3#;
   pragma Export (C, u00168, "system__img_llliS");
   u00169 : constant Version_32 := 16#ed04c351#;
   pragma Export (C, u00169, "system__img_lllwS");
   u00170 : constant Version_32 := 16#ccb35a24#;
   pragma Export (C, u00170, "system__img_llwS");
   u00171 : constant Version_32 := 16#e20553c3#;
   pragma Export (C, u00171, "system__img_wiuS");
   u00172 : constant Version_32 := 16#aa0160a2#;
   pragma Export (C, u00172, "system__val_intS");
   u00173 : constant Version_32 := 16#5da6ebca#;
   pragma Export (C, u00173, "system__val_unsS");
   u00174 : constant Version_32 := 16#a5fee39b#;
   pragma Export (C, u00174, "system__val_llliS");
   u00175 : constant Version_32 := 16#1e4a2c79#;
   pragma Export (C, u00175, "system__val_llluS");
   u00176 : constant Version_32 := 16#f8342e50#;
   pragma Export (C, u00176, "ada__numerics__big_numbers__big_realsB");
   u00177 : constant Version_32 := 16#eafe85fe#;
   pragma Export (C, u00177, "ada__numerics__big_numbers__big_realsS");
   u00178 : constant Version_32 := 16#d79db92c#;
   pragma Export (C, u00178, "system__return_stackS");
   u00179 : constant Version_32 := 16#b3b3c0a5#;
   pragma Export (C, u00179, "ada__numerics__big_numbers__big_integersB");
   u00180 : constant Version_32 := 16#7e6fac86#;
   pragma Export (C, u00180, "ada__numerics__big_numbers__big_integersS");
   u00181 : constant Version_32 := 16#dfb555d4#;
   pragma Export (C, u00181, "system__shared_bignumsS");
   u00182 : constant Version_32 := 16#e259c480#;
   pragma Export (C, u00182, "system__assertionsB");
   u00183 : constant Version_32 := 16#322b1494#;
   pragma Export (C, u00183, "system__assertionsS");
   u00184 : constant Version_32 := 16#8b2c6428#;
   pragma Export (C, u00184, "ada__assertionsB");
   u00185 : constant Version_32 := 16#cc3ec2fd#;
   pragma Export (C, u00185, "ada__assertionsS");
   u00186 : constant Version_32 := 16#756a1fdd#;
   pragma Export (C, u00186, "system__stream_attributesB");
   u00187 : constant Version_32 := 16#a8236f45#;
   pragma Export (C, u00187, "system__stream_attributesS");
   u00188 : constant Version_32 := 16#1c617d0b#;
   ...
   --  ada.numerics.big_numbers.big_reals%s
   --  ada.numerics.big_numbers.big_reals%b
   --  system.img_lli%s
   --  system.img_llli%s
